...
| 6a. Importação nacional do Open Charge Map | Brasil inteiro (~1.750 pontos), desativação dos que saírem da base, paginação da lista no painel | Pendência da 3b |
...
- ~~Ampliar a importação do Open Charge Map além do raio de 60 km de Betim~~ — resolvida
  na etapa 6a (importação nacional, spec 08).
